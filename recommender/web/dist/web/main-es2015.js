...
let MoviePageResolverService = class MoviePageResolverService {
...
let UserPageResolverService = class UserPageResolverService {
    constructor(httpService) {
        this.httpService = httpService;
    }
    resolve(route, state) {
...
let MoviePageComponent = class MoviePageComponent {
    constructor(httpService, activatedRoute, router) {
        this.httpService = httpService;
